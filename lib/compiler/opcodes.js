...
const opcodes = {
    ...
    POP_N: 8, // POP_N n, drop the previous N match result, which is used for sequence match fail in Nth elements
    NIP: 9, // NIP
    ...
    IF: 13, // IF t, f
    IF_ERROR: 14, // IF_ERROR t, f, if the match result is failure
    IF_NOT_ERROR: 15, // IF_NOT_ERROR t, f, if the match result is not failure
